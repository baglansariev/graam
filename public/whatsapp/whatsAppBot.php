...
class whatsAppBot
{
    private $APIurl = 'https://api.green-api.com/waInstance8598/';
    private $token = '/68a76b11aa820669e236bacb7843d8cd54a9a55c62a4e120f8';
    private $host = 'localhost';
    private $database = 'graam_ark';
    private $user = 'root';
    private $password = 'Ud4aRHsK2WQk7d7X';
