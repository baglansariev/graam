...
//                'path'              => '',
    ...
    public function getDocNamesList()
    {
        ...
        'Анкета юр.лица/ИП',
        'Скан-копия свидетельства ОГРН/Лист записи о создании ЮЛ',
        'Скан-копия свидетельства ИНН',
        'Скан-копия уведомления о поставке на спец. учет (со всеми изменениями)',
        'Скан-копия карты спец. учета',
        'Скан-копия уведомления статистики',
        'Скан-копия решения или протокола о создании ЮЛ',
        'Скан-копия решения или протокола о назначении ген. директора',
        'Скан-копия приказа о назначении ген. директора',
        'Скан-копия паспорта ген. директора/Анкета бенефициара (-ов)',
        'Скан-копия Устава ЮЛ'
    ];
    }
}
