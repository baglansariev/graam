...
@section('content')
        ...
        @endif
         ...
         <form action="{{ route('user.update', $user->id) }}" method="post" class="col-md-12 info">
             ...
             @if (isset($user_details->entity_type) && $user_details->entity_type == 2)
             ...
             @else
                 ...
                 <div class="form-row">
                     <div class="form-group col-md-6">
                         ...
                         <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $user_details->name ?? 'Название компании'}}">
                     </div>
                     <div class="form-group col-md-6">
                         <label for="inputEmail4">Электронная почта</label>
                         @if (isset($user_details->email) && !empty($user_details->email))
